  ...
  styles: [
    `
      ...
      .menu-list ion-item.is-active {
        ...
        box-shadow: 0 6px 16px rgba(76, 111, 255, 0.12);
      }
        ...
        <ion-content>
          ...
          <ion-list class="menu-list" inset="true" lines="none">
            <ion-menu-toggle auto-hide="true">
              ...
              >
                <ion-label
                  ><span class="emoji">🏠</span> Página Inicial</ion-label
                >
              </ion-item>
            </ion-menu-toggle>
            ...
            <ion-menu-toggle auto-hide="true">
              ...
              >
                <ion-label
                  ><span class="emoji">🪑</span> Mesas Livres</ion-label
                >
              </ion-item>
            </ion-menu-toggle>
            ...
            <ion-menu-toggle auto-hide="true">
              ...
              >
                <ion-label
                  ><span class="emoji">🍕</span> Cardápio</ion-label
                >
              </ion-item>
            </ion-menu-toggle>
          </ion-list>
